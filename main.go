// Структуру программы следует организовать в соответствии с Domein Drive Development,
// (то есть разбить программу на сервисы), а структуру папок в соответствии с метотологией
...
// Работу с БД желательно спрятать за интерфейс. 
...
// Нет нужды передавать по указателю author *string (author string). Метод должнен возвращать результат и ошибку.
...
func main() {
	...
	r := mux.NewRouter()
  // Хендле функцию желательно вынести в метод структуры.
